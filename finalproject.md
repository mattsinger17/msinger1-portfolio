...
| Question Asked | Respondee #1 | Respondee #2 | Respondee #3 |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| On a scale of 1 to 5, with 5 being the highest, how familiar  were you with the scale and density of publicly-owned properties  within the geographic boundaries of the City of Pittsburgh? | 4 | 2 | 5 |
| Using just a few words, list the first negative consequence that  comes to mind when I raise the issue of vacant properties? | Quality of Life | Home Prices | Neighborhood  Quality of Life |
| Yes or no, does this map clearly indicate the areas in which there are great numbers of publicly-owned vacant land? | No | No | Yes |
| Following the last question, can you explain your answer? | There's no key or legend, which makes it harder to tell what the gradient means than it needs  to be for me as a reader. | The colors were confusing  and don't match each other. | The color scale  could be clearer, but familiarity with data and background on subject matter  helped understanding. |
| Please explore this graphic using my computer. After doing so  for approximately 30 seconds, can you tell me what the circles represent? | They're not home prices, but  I can't really tell what they're  supposed to refer to. | I don't know. | They're referencing counts of 311 tickets. |
| Following the last question, what would make it clearer that these circles correspond to aggregate 311 complaints tied to a specific issue for the associated neighborhood in that year? | You should add more labels  or guides to make it clearer. | It would be easier to figure  it all out if the symbols were more different. | Without an axis to  guide me, I had to use  the little bubble message  hint about it being a  complaint number to figure out that it was 311-related.  |
